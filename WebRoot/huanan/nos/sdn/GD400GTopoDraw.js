...
function loadGDCityTopoInfo(para){
		...
		R.removeSpinner(loading);
			...
			raphael_tooltip(R,DEV00527,DEV00527Txt,xDG+50,yDG-30-10);
			...
			raphael_tooltip(R,DEV00526,DEV00526Txt,xDG+50,yDG-30-10);
			...
			raphael_tooltip(R,DEV00051,DEV00051Txt,xFS+50,yFS-30-10);
			...
			raphael_tooltip(R,DEV00050,DEV00050Txt,xFS+50,yFS-30-10);
			...
			raphael_tooltip(R,DEV007v7,DEV007v7Txt,xGZ+50,yGZ-30-10);
			...
			raphael_tooltip(R,DEV007pn,DEV007pnTxt,xGZ+50,yGZ-30-10);
			...
			raphael_tooltip(R,DEV005yc,DEV005ycTxt,xGZC+50,yGZC-30-10);
			...
			raphael_tooltip(R,DEV002h0,DEV002h0Txt,xGZC+50,yGZC-30-10);
			...
			raphael_tooltip(R,DEV002h1,DEV002h1Txt,xGZC+50,yGZC-30-10);
			...
			raphael_tooltip(R,DEV0045b,DEV0045bTxt,xGZC+50,yGZC-30-10);
			...
			raphael_tooltip(R,DEV0055f,DEV0055fTxt,xGZC+50,yGZC-30-10);
			...
			raphael_tooltip(R,DEV005yb,DEV005ybTxt,xGZC+50,yGZC-30-10);
			...
			raphael_tooltip(R,DEV01863,DEV01863Txt,xGZC+50,yGZC-30-10);
			...
			raphael_tooltip(R,DEV01862,DEV01862Txt,xGZC+50,yGZC-30-10);
			...
			raphael_tooltip(R,DEV002gt,DEV002gtTxt,xGZIDC+50,yGZIDC-30-10);
			...
			raphael_tooltip(R,DEV002gu,DEV002guTxt,xGZIDC+50,yGZIDC-30-10);
			...
			raphael_tooltip(R,DEV0056f,DEV0056fTxt,xPIDC+50,yPIDC-30-10);
			...
			raphael_tooltip(R,DEV0056g,DEV0056gTxt,xPIDC+50,yPIDC-30-10);
			...
			raphael_tooltip(R,DEV0056d,DEV0056dTxt,xPIDC+50,yPIDC-30-10);
			...
			raphael_tooltip(R,DEV0056e,DEV0056eTxt,xPIDC+50,yPIDC-30-10);
			...
			raphael_tooltip(R,DEV00f5f,DEV00f5fTxt,xSZ+50,ySZ-30-10);
			...
			raphael_tooltip(R,DEV0063b,DEV0063bTxt,xSZ+50,ySZ-30-10);
			...
			raphael_tooltip(R,DEV01286,DEV01286Txt,xSZD+50,ySZD-30-10);
			...
			raphael_tooltip(R,DEV01285,DEV01285Txt,xSZD+50,ySZD-30-10);
			...
			raphael_tooltip(R,DEV008hz,DEV008hzTxt,xSZD+50,ySZD-30-10);
			...
			raphael_tooltip(R,DEV008nj,DEV008njTxt,xSZD+50,ySZD-30-10);
			...
			raphael_tooltip(R,DEV0079k,DEV0079kTxt,xSZIDC+50,ySZIDC-30-10);
			...
			raphael_tooltip(R,DEV0079j,DEV0079jTxt,xSZIDC+50,ySZIDC-30-10);
			...
			raphael_tooltip(R,DEV004uc,DEV004ucTxt,xYB+50,yYB-30-10);
			...
			raphael_tooltip(R,DEV004ub,DEV004ubTxt,xYB+50,yYB-30-10);
			...
			raphael_tooltip(R,DEV0053c,DEV0053cTxt,xYD+50,yYD-30-10);
			...
			raphael_tooltip(R,DEV0053a,DEV0053aTxt,xYD+50,yYD-30-10);
			...
			raphael_tooltip(R,DEV005ev,DEV005evTxt,xYX+50,yYX-30-10);
			...
			raphael_tooltip(R,DEV005ew,DEV005ewTxt,xYX+50,yYX-30-10);
			...
			raphael_tooltip(R,DEV0022w,DEV0022wTxt,xZSJ+50,yZSJ-30-10);
			...
			raphael_tooltip(R,DEV0022v,DEV0022vTxt,xZSJ+50,yZSJ-30-10);
		

R.line(DEV0022w,DEV01286,0);
R.line(DEV0022w,DEV008hz,0);
R.line(DEV0022w,DEV01862,0);
R.line(DEV0022w,DEV0055f,0);
R.line(DEV005ew,DEV01286,0);
R.line(DEV005ew,DEV008hz,0);
R.line(DEV005ew,DEV01862,0);
R.line(DEV005ew,DEV0055f,0);
R.line(DEV0053c,DEV01286,0);
R.line(DEV0053c,DEV008hz,0);
R.line(DEV0053c,DEV01862,0);
R.line(DEV0053c,DEV0055f,0);
R.line(DEV004uc,DEV01286,0);
R.line(DEV004uc,DEV008hz,0);
R.line(DEV004uc,DEV01862,0);
R.line(DEV004uc,DEV0055f,0);
R.line(DEV00f5f,DEV01286,0);
R.line(DEV00f5f,DEV008hz,0);
R.line(DEV00f5f,DEV01863,0);
R.line(DEV00f5f,DEV0045b,0);
R.line(DEV0079k,DEV01286,0);
R.line(DEV0079k,DEV008hz,0);
R.line(DEV0079k,DEV01863,0);
R.line(DEV0079k,DEV0045b,0);
R.line(DEV0063b,DEV01285,0);
R.line(DEV0063b,DEV008nj,0);
R.line(DEV0063b,DEV01862,0);
R.line(DEV0063b,DEV0055f,0);
R.line(DEV0079j,DEV01285,0);
R.line(DEV0079j,DEV008nj,0);
R.line(DEV0079j,DEV01862,0);
R.line(DEV0079j,DEV0055f,0);
R.line(DEV007v7,DEV01286,0);
R.line(DEV007v7,DEV008hz,0);
R.line(DEV007v7,DEV01862,0);
R.line(DEV007v7,DEV0055f,0);
R.line(DEV0022v,DEV01285,0);
R.line(DEV0022v,DEV008nj,0);
R.line(DEV0022v,DEV01863,0);
R.line(DEV0022v,DEV0045b,0);
R.line(DEV005ev,DEV01285,0);
R.line(DEV005ev,DEV008nj,0);
R.line(DEV005ev,DEV01863,0);
R.line(DEV005ev,DEV0045b,0);
R.line(DEV0053a,DEV01285,0);
R.line(DEV0053a,DEV008nj,0);
R.line(DEV0053a,DEV01863,0);
R.line(DEV0053a,DEV0045b,0);
R.line(DEV004ub,DEV01285,0);
R.line(DEV004ub,DEV008nj,0);
R.line(DEV004ub,DEV01863,0);
R.line(DEV004ub,DEV0045b,0);
R.line(DEV002gu,DEV01285,0);
R.line(DEV002gu,DEV008nj,0);
R.line(DEV002gu,DEV01863,0);
R.line(DEV002gu,DEV0045b,0);
R.line(DEV005yc,DEV01863,0);
R.line(DEV005yb,DEV01862,0);
R.line(DEV002gt,DEV01286,0);
R.line(DEV002gt,DEV008hz,0);
R.line(DEV002gt,DEV01862,0);
R.line(DEV002gt,DEV0055f,0);
R.line(DEV007pn,DEV008hz,0);
R.line(DEV007pn,DEV01285,0);
R.line(DEV007pn,DEV008nj,0);
R.line(DEV007pn,DEV01863,0);
R.line(DEV007pn,DEV0045b,0);
R.line(DEV0056g,DEV01286,0);
R.line(DEV0056g,DEV008hz,0);
R.line(DEV0056f,DEV01285,0);
R.line(DEV0056f,DEV008nj,0);
R.line(DEV002h0,DEV008hz,0);
R.line(DEV002h0,DEV01863,0);
R.line(DEV002h0,DEV0045b,0);
R.line(DEV0056e,DEV01863,0);
R.line(DEV0056e,DEV0045b,0);
R.line(DEV002h1,DEV008nj,0);
R.line(DEV002h1,DEV01862,0);
R.line(DEV002h1,DEV0055f,0);
R.line(DEV0056d,DEV01862,0);
R.line(DEV0056d,DEV0055f,0);
R.line(DEV00051,DEV01285,0);
R.line(DEV00051,DEV008nj,0);
R.line(DEV00051,DEV01862,0);
R.line(DEV00051,DEV0055f,0);
R.line(DEV00050,DEV01286,0);
R.line(DEV00050,DEV008hz,0);
R.line(DEV00050,DEV01863,0);
R.line(DEV00050,DEV0045b,0);
R.line(DEV00527,DEV01285,0);
R.line(DEV00527,DEV008nj,0);
R.line(DEV00527,DEV01863,0);
R.line(DEV00527,DEV0045b,0);
R.line(DEV00526,DEV01286,0);
R.line(DEV00526,DEV008hz,0);
R.line(DEV00526,DEV01862,0);
R.line(DEV00526,DEV0055f,0);
}